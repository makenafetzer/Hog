...
def hogtimus_prime(score):
    """Return the next highest prime if score is prime.
    >>>hogtimus_prime(11)
    >>>13
    """
    def is_prime(score):
...
def take_turn(num_rolls, opponent_score, dice=six_sided):
    ...
    if num_rolls == 0:
        ...
        if hogtimus_prime(uncapped_score):
            uncapped_score = hogtimus_prime(uncapped_score)
        if uncapped_score > (25 - num_rolls):
            return (25 - num_rolls)
        return uncapped_score
    # END PROBLEM 2
...
def play(strategy0, strategy1, score0=0, score1=0, goal=GOAL_SCORE):
    ...
    while score0 < goal and score1 < goal:
        if strategy0(score0, score1) == -1:
            ...
            turn_dice = select_dice(score0, score1, dice_swapped)
            points = take_turn(strategy0(score0, score1), score1, select_dice(score0, score1, dice_swapped))
        ...
        if strategy1(score1, score0) == -1:
            ...
            turn_dice = select_dice(score1, score0, dice_swapped)
            points = take_turn(strategy1(score1, score0), score0, select_dice(score1, score0, dice_swapped))
...
def max_scoring_num_rolls(dice=six_sided, num_samples=1000):
    ...
    for num_rolls in range(2, 11):
        if make_averaged(roll_dice)(num_rolls, dice) >= make_averaged(roll_dice)(max_dice, dice):
            max_dice = num_rolls
    return max_dice
    # END PROBLEM 8
...
def swap_strategy(score, opponent_score, margin=8, num_rolls=4):
    ...
    """
    # BEGIN PROBLEM 10
    if free_bacon(opponent_score) >= 100 - score or hogtimus_prime(free_bacon(opponent_score)) >= 100 - score:
        return 0
    elif hogtimus_prime(free_bacon(opponent_score)):
        if (score + hogtimus_prime(free_bacon(opponent_score))) == 0.5*opponent_score:
            return 0
        elif hogtimus_prime(free_bacon(opponent_score)) >= margin:
            return 0
    elif (score + free_bacon(opponent_score)) == 0.5*(opponent_score):
        return 0
...
def final_strategy(score, opponent_score):
    """Evaluates the score and opponent's score to return the most strategic number of rolls.
    ...
    if score == 0:
        return -1
    #Auto Win
    if  not swap_strategy(score, opponent_score, margin, num_rolls):
        return 0
    elif score >= 89 and opponent_score > 69:
        return 0
    elif score > 81:
        return -1
    #Avoid Bad Swaps
    if opponent_score + 1 == 0.5 * score:
        return num_rolls
    #Change Risk
    if opponent_score - score > 55:
        margin = 9
        num_rolls = 6
